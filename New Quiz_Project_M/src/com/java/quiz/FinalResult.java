	...
	public static void finalResult()
	{
				...
				boolean flag =true;
					 while(set.next())
					 {
						...
						ResultSet set1=	smtt.executeQuery("select studentinfo.id,studentinfo.Fname,studentinfo.Lname,result.marks from studentinfo join result on studentinfo.id=result.rid ");
							 ...
							 while(set1.next())
							 {
								...
								if (id.equals(idr)) // For selective user data
								{
